from .views import create_reading_plan, reading_plan_detail, log_progress, weekly_report, check_falling_behind,reading_dashboard, create_goal_view, delete_goal,about_shelfbuddy, edit_reading_plan,delete_reading_plan
...
path('reading/delete/<int:plan_id>/', delete_reading_plan, name='delete_reading_plan'),
]